...
import { ref, resolveComponent, resolveDirective, mergeProps, withCtx, createTextVNode, createVNode, unref, isRef, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "styleguide container p-4" }, _attrs))}>`);
...
//# sourceMappingURL=styleguide-DmpXjSJz.js.map
