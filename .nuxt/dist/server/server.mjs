import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineComponent, provide, createElementBlock, openBlock, Fragment, renderList, normalizeClass, createElementVNode, mergeProps, toDisplayString, createCommentVNode, createBlock, resolveDynamicComponent, createVNode, Transition, withCtx, withDirectives, vShow, renderSlot, resolveDirective, Teleport, normalizeStyle, resolveComponent, createSlots, createTextVNode, computed, withKeys, toHandlers, Suspense, nextTick, watch, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/dashboard-Bcw57Xm4.js").then((m) => m.default || m)
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    component: () => import("./_nuxt/forgot-password-CXjZ4PO3.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C9Wl6omj.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-D2QxmlNG.js").then((m) => m.default || m)
  },
  {
    name: "logout",
    path: "/logout",
    component: () => import("./_nuxt/logout-D3mj0QyR.js").then((m) => m.default || m)
  },
  {
    name: "magic-link",
    path: "/magic-link",
    component: () => import("./_nuxt/magic-link-Cy1p-zaT.js").then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/settings-MQUZ2Tra.js").then((m) => m.default || m)
  },
  {
    name: "sign-up-saved",
    path: "/sign-up-saved",
    component: () => import("./_nuxt/sign-up-saved-CsLweDRW.js").then((m) => m.default || m)
  },
  {
    name: "styleguide",
    path: "/styleguide",
    component: () => import("./_nuxt/styleguide-HpxphKME.js").then((m) => m.default || m)
  },
  {
    name: "success",
    path: "/success",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/success-DksWiA1i.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-DlS4aTSt.js")
};
...
const layouts = {
  default: () => import("./_nuxt/default-2zPrS1Qp.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-paxJ11uz.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Crg5NkAA.js").then((r) => r.default || r));
