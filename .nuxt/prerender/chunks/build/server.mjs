import { hasInjectionContext, inject, version, unref, toRef, isRef, defineComponent, ref, provide, createElementBlock, h, computed, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, defineAsyncComponent, shallowRef, isReadonly, withCtx, isShallow, isReactive, toRaw, openBlock, renderList, normalizeClass, createElementVNode, toDisplayString, createCommentVNode, createBlock, withDirectives, vShow, renderSlot, resolveDirective, Teleport, normalizeStyle, resolveComponent, createSlots, createTextVNode, withKeys, toHandlers } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, getRequestHeader, createError as createError$1, setCookie, getCookie, deleteCookie, appendHeader } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/ufo/dist/index.mjs';
import { parse } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/klona/dist/index.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/kimlarocca/Websites/just-day-space/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./dashboard-Bcw57Xm4.mjs').then((m) => m.default || m)
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    component: () => import('./forgot-password-CXjZ4PO3.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C9Wl6omj.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-D2QxmlNG.mjs').then((m) => m.default || m)
  },
  {
    name: "logout",
    path: "/logout",
    component: () => import('./logout-D3mj0QyR.mjs').then((m) => m.default || m)
  },
  {
    name: "magic-link",
    path: "/magic-link",
    component: () => import('./magic-link-Cy1p-zaT.mjs').then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./settings-MQUZ2Tra.mjs').then((m) => m.default || m)
  },
  {
    name: "sign-up-saved",
    path: "/sign-up-saved",
    component: () => import('./sign-up-saved-CsLweDRW.mjs').then((m) => m.default || m)
  },
  {
    name: "styleguide",
    path: "/styleguide",
    component: () => import('./styleguide-HpxphKME.mjs').then((m) => m.default || m)
  },
  {
    name: "success",
    path: "/success",
    meta: __nuxt_page_meta || {},
    component: () => import('./success-DksWiA1i.mjs').then((m) => m.default || m)
  }
];
...
const _hoisted_1$j = { class: "p-accordion p-component" };
const _hoisted_2$f = ["data-index"];
const _hoisted_3$a = ["id", "tabindex", "aria-disabled", "aria-expanded", "aria-controls", "onClick", "onKeydown"];
const _hoisted_4$7 = {
  key: 0,
  class: "p-accordion-header-text"
};
const _hoisted_5$6 = ["id", "aria-labelledby"];
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", mergeProps({
          ...
          createElementVNode("a", mergeProps({
            ...
            tab.props && tab.props.header ? (openBlock(), createElementBlock("span", _hoisted_4$7, toDisplayString(tab.props.header), 1)) : createCommentVNode("", true),
...
const _hoisted_1$i = ["aria-labelledby", "aria-label"];
const _hoisted_2$e = {
  key: 0,
  class: "p-avatar-text"
};
...
function render$k(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      $props.label ? (openBlock(), createElementBlock("span", _hoisted_2$e, toDisplayString($props.label), 1)) : $props.icon ? (openBlock(), createElementBlock("span", {
        key: 1,
...
const _hoisted_2$d = { class: "p-button-label" };
function render$j(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("button", {
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      ...
      createElementVNode("span", _hoisted_2$d, toDisplayString($props.label || " "), 1),
...
function render$h(_ctx, _cache, $props, $setup, $data, $options) {
  return !$props.disabled ? (openBlock(), createElementBlock("div", {
    ...
    !$props.loaderDisabled && $props.showLoader && $data.d_loading ? (openBlock(), createElementBlock("div", {
      ...
      }), 128)) : (openBlock(), createElementBlock("i", _hoisted_2$c))
    ], 2)) : createCommentVNode("", true)
  ], 46, _hoisted_1$g)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
    renderSlot(_ctx.$slots, "default"),
    renderSlot(_ctx.$slots, "content", {
      items: $props.items,
      rows: $props.items,
...
const _hoisted_1$f = ["id", "value", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant"];
const _hoisted_2$b = ["aria-activedescendant"];
const _hoisted_3$8 = ["id", "aria-label", "aria-setsize", "aria-posinset"];
const _hoisted_4$6 = { class: "p-autocomplete-token-label" };
const _hoisted_5$5 = ["onClick"];
const _hoisted_6$2 = {
  class: "p-autocomplete-input-token",
  role: "option"
};
const _hoisted_7$2 = ["id", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant"];
const _hoisted_8$2 = {
  role: "status",
  "aria-live": "polite",
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    }, $props.inputProps), null, 16, _hoisted_1$f)) : createCommentVNode("", true),
    $props.multiple ? (openBlock(), createElementBlock("ul", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.modelValue, (option, i) => {
        return openBlock(), createElementBlock("li", {
          ...
          renderSlot(_ctx.$slots, "chip", { value: option }, () => [
            createElementVNode("span", _hoisted_4$6, toDisplayString($options.getOptionLabel(option)), 1)
          ]),
          createElementVNode("span", {
      ...
      createElementVNode("li", _hoisted_6$2, [
        ...
        }, $props.inputProps), null, 16, _hoisted_7$2)
      ])
    ...
    createElementVNode("span", _hoisted_8$2, toDisplayString($options.searchResultMessageText), 1),
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              createElementVNode("span", _hoisted_12$1, toDisplayString($options.selectedMessageText), 1)
...
const _hoisted_1$e = { class: "p-hidden-accessible" };
...
const _hoisted_1$d = ["aria-labelledby", "aria-modal"];
...
const _hoisted_1$c = ["aria-orientation"];
const _hoisted_2$8 = {
  key: 0,
...
const _hoisted_1$a = { class: "p-message-wrapper" };
...
var script$8 = {
  ...
  components: {
    FileUploadButton: script$j,
    FileUploadProgressBar: script$a,
    FileUploadMessage: script$b,
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _directive_ripple = resolveDirective("ripple");
  return $options.isAdvanced ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
...
const _hoisted_1$7 = { class: "p-inline-message-text" };
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", {
    ...
    $props.showButtons && $props.buttonLayout === "stacked" ? (openBlock(), createElementBlock("span", _hoisted_1$4, [
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createElementVNode("span", _hoisted_1$2, toDisplayString($data.infoText), 1),
    createVNode(_component_Portal, { appendTo: $props.appendTo }, {
      default: withCtx(() => [
        createVNode(Transition, {
          name: "p-connected-overlay",
...
const primevue_TdXjRgL1MA = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp.vueApp.component("Accordion", script$m);
  nuxtApp.vueApp.component("AccordionTab", script$l);
  nuxtApp.vueApp.component("Avatar", script$k);
  nuxtApp.vueApp.component("AutoComplete", script$g);
  nuxtApp.vueApp.component("Button", script$j);
  nuxtApp.vueApp.component("Checkbox", script$f);
  nuxtApp.vueApp.component("Dialog", script$e);
  nuxtApp.vueApp.component("Divider", script$d);
  nuxtApp.vueApp.component("Dropdown", script$c);
  nuxtApp.vueApp.component("FileUpload", script$8);
  nuxtApp.vueApp.component("InlineMessage", script$7);
  nuxtApp.vueApp.component("InputSwitch", script$3);
  nuxtApp.vueApp.component("InputText", script$5);
  nuxtApp.vueApp.component("InputMask", script$6);
  nuxtApp.vueApp.component("InputNumber", script$4);
  nuxtApp.vueApp.component("Message", script$b);
  nuxtApp.vueApp.component("Password", script$2);
  nuxtApp.vueApp.component("ProgressBar", script$a);
  nuxtApp.vueApp.component("ProgressSpinner", script$1);
...
const layouts = {
  default: () => import('./default-2zPrS1Qp.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-paxJ11uz.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Crg5NkAA.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useSupabaseUser as a, useRoute as b, useRuntimeConfig as c, defineNuxtRouteMiddleware as d, entry$1 as default, executeAsync as e, useNuxtApp as f, useSupabaseToken as g, useRouter as h, injectHead as i, nuxtLinkDefaults as j, resolveRouteObject as k, navigateTo as n, resolveUnrefHeadInput as r, useState as u };
